...
CREATE TABLE `doctor_address` (
  ...
  CONSTRAINT `fk_doctor_adress` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`)
...
INSERT INTO `doctor_address` VALUES (1,'lal  bahadur shastri road','silchar','assam'),(2,NULL,'silchar','assam');
