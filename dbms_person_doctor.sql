...
CREATE TABLE `person_doctor` (
  ...
  KEY `fk_person_doctor_person_id_idx` (`person_id`),
  KEY `fk_person_doctor_doctor_id_idx` (`doctor_id`),
  CONSTRAINT `fk_person_doctor_doctor_id` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`),
  CONSTRAINT `fk_person_doctor_person_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`)
...
INSERT INTO `person_doctor` VALUES (1,2),(2,1),(3,1),(4,1),(5,2),(6,2),(7,1),(8,2),(9,2),(10,1);
